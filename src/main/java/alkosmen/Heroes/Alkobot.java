...
import alkosmen.Objects.Bottle;
import greenfoot.Actor;
import greenfoot.Greenfoot;
import greenfoot.World;

public class Alkobot extends Actor {
    public double score = 0.5;
    private int ax;
    private int ay;

    /**
     * Act - do whatever the alk wants to do. This method is called whenever the
